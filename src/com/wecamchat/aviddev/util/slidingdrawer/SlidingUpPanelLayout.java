package com.wecamchat.aviddev.util.slidingdrawer;
...
public class SlidingUpPanelLayout extends ViewGroup {
	...
	public SlidingUpPanelLayout(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.text);
	}
	...
	public SlidingUpPanelLayout(Context context, AttributeSet attrs,
		...
		if (attrs != null) {
			...
			if (ta != null) {
				...
				Log.d(TAG, " mDragViewResId: " + mDragViewResId);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		final int childCount = getChildCount();
		Log.d(TAG, "mFirstLayout: " + mFirstLayout + " PanelState :"
				+ mSlideState);
		if (mFirstLayout) {
			switch (mSlideState) {
			case EXPANDED:
	...
	boolean smoothSlideTo(float slideOffset, int velocity) {
		...
		if (mDragHelper.smoothSlideViewTo(mSlideableView,
				mSlideableView.getLeft(), panelTop, velocity)) {
	...
	private class DragHelperCallback extends ViewDragHelper.Callback {
		...
		public void onViewReleased(View releasedChild, float xvel, float yvel) {
			...
			Log.d(TAG, "mSlideOffset : " + mSlideOffset + ", direction : "
					+ direction);
			if (direction > 0) {
				// swipe up -> expand
				...
				target = computePanelTopPosition(0);
