...
class Bar {
    ...
    private static final int BAR_BG = R.drawable.range_slider_bg;

    private final Bitmap barBgBitmap;

    // private Paint barBoundaryPaint;
    ...
    Bar(Context ctx, float x, float y, float length, int tickCount,
        ...
        // mPaint.setStrokeWidth(BarWeight - 4);
        // mPaint.setAntiAlias(true);
        // barBoundaryPaint = new Paint();
        // barBoundaryPaint.setColor(Color.GRAY);
        // barBoundaryPaint.setStrokeWidth(BarWeight);
        // barBoundaryPaint.setAntiAlias(true);

        final Resources res = ctx.getResources();
        barBgBitmap = BitmapFactory.decodeResource(res, BAR_BG);
    }
    ...
    void draw(Canvas canvas) {
        // canvas.drawLine(mLeftX - 3, mY, mRightX + 3, mY, barBoundaryPaint);
        // canvas.drawLine(mLeftX, mY, mRightX, mY, mPaint);
        canvas.drawBitmap(barBgBitmap, 15, mY - barBgBitmap.getHeight() / 2,
                null);
