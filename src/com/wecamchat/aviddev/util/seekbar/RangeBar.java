...
package com.wecamchat.aviddev.util.seekbar;
...
public class RangeBar extends View {
    ...
    private String LeftThumbText;
    private String rightThumbText;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mLeftThumb = new Thumb(ctx, yPos, mThumbColorNormal,
                ...
                mThumbImagePressed, isSingleThumb);
        ...
        final float barLength = w - (2f * marginLeft);
        // if (isSingleThumb) {
        // barLength = w - (3f * marginLeft);
        // } else {
        // barLength = w - (4f * marginLeft);
        // }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!isSingleThumb) {
            ...
            mLeftThumb.draw(canvas, LeftThumbText);
            mRightThumb.draw(canvas, rightThumbText);
        } else {
            mLeftThumb.draw(canvas, LeftThumbText);
        }
    ...
    private void createThumbs() {
        ...
        if (!isSingleThumb) {
            ...
            mRightThumb = new Thumb(ctx, yPos, mThumbColorNormal,
                    ...
                    mThumbImagePressed, isSingleThumb);
            // Initialize thumbs to the desired indices
            mLeftThumb.setX(marginLeft
                    + (mLeftIndex / (float) (mTickCount - 1)) * barLength);
            mRightThumb.setX(marginLeft
                    + (mRightIndex / (float) (mTickCount - 1)) * barLength);
        } else {
            mLeftThumb = new Thumb(ctx, yPos, mThumbColorNormal,
                    mThumbColorPressed, mThumbRadiusDP, mThumbImageNormal,
                    mThumbImagePressed, isSingleThumb);
    ...
    private void onActionMove(float x) {
        ...
        if (!isSingleThumb) {
            ...
            if (newLeftIndex != mLeftIndex) {
                mLeftIndex = newLeftIndex;
                if (mListener != null) {
                    mListener.onIndexChangeListener(this, mLeftIndex, 0);
                }
            }
    ...
    public String getLeftThumbText() {
        return LeftThumbText;
    }

    public void setLeftThumbText(String leftThumbText) {
        LeftThumbText = leftThumbText;
    }

    public String getRightThumbText() {
        return rightThumbText;
    }

    public void setRightThumbText(String rightThumbText) {
        this.rightThumbText = rightThumbText;
    }

    public boolean isSingleThumb() {
        return isSingleThumb;
    }

    public void setSingleThumb(boolean isSingleThumb) {
        this.isSingleThumb = isSingleThumb;
    }
